...
var arc = d3.svg_chord_a.arc()
  .innerRadius(innerRadius*1.01)
  .outerRadius(outerRadius);

var path = d3.svg_chord_a.chord()
.radius(innerRadius);
...
var svg_chord_a = d3.select("#chart").append("svg")
...
var grads = svg_chord_a.append("defs").selectAll("linearGradient")
.data(chord.chords())
...
var outerArcs = svg_chord_a.selectAll("g.group")
.data(chord.groups)
.enter().append("g")
.attr("class", "group")
.on("mouseover", fade(.1))
...
svg_chord_a.selectAll("path.chord")
.data(chord.chords)
.enter().append("path")
.attr("class", "chord")
